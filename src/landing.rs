...
<title>Concierge — Automate customer engagement for your small business</title>
<meta name="description" content="WhatsApp auto-replies, Google Calendar bookings, Instagram-to-calendar sync, and form automation. One platform, zero effort.">
<style>
...
.features{{max-width:960px;margin:0 auto;padding:4rem 1rem 6rem;display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:2rem}}
...
<div class="hero-inner">
  ...
  <p>Automate WhatsApp replies, calendar bookings, Instagram events, and form follow-ups — all from one place. Built for small businesses that move fast.</p>
  <div class="cta-row">
...
<div class="feature">
  <span class="feature-icon" aria-hidden="true">{calendar}</span>
  <h3>Calendar Bookings</h3>
  <p>Embeddable booking pages with Google Calendar sync, approval workflows, and WhatsApp confirmations.</p>
</div>
<div class="feature">
  <span class="feature-icon" aria-hidden="true">{instagram}</span>
  <h3>Instagram &rarr; Calendar</h3>
  <p>Post an event on Instagram — AI extracts the details and adds it to your Google Calendar automatically.</p>
</div>
<div class="feature">
  <span class="feature-icon" aria-hidden="true">{form}</span>
  <h3>Form &rarr; WhatsApp</h3>
  <p>Someone fills out your Google Form? They get an instant WhatsApp reply. No code, no zaps, no delays.</p>
</div>
</section>
...
<div class="steps">
  ...
  <div class="step">
    ...
    <div class="step-body">
      ...
      <p>Link WhatsApp, Google Calendar, Google Forms, or Instagram — whichever you need.</p>
    </div>
  </div>
  <div class="step">
    <div class="step-num"></div>
    <div class="step-body">
      ...
      <p>Choose what happens when a message arrives, a form is submitted, or a post goes up. Done.</p>
    </div>
  </div>
</div>
</section>
...
<a href="https://github.com/ananthb/concierge-worker">GitHub</a>
        ...
        // Inline SVG icons — use r##""## to allow "# in fill colors
        ...
        calendar = r##"<svg width="40" height="40" viewBox="0 0 24 24" fill="#0070f3"><path d="M19 4h-1V2h-2v2H8V2H6v2H5c-1.11 0-1.99.9-1.99 2L3 20a2 2 0 002 2h14c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 16H5V10h14v10zm0-12H5V6h14v2zM9 14H7v-2h2v2zm4 0h-2v-2h2v2zm4 0h-2v-2h2v2zm-8 4H7v-2h2v2zm4 0h-2v-2h2v2zm4 0h-2v-2h2v2z"/></svg>"##,
