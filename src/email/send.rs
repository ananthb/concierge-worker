...
//! headers}`). Email Service rejects raw RFC 2822 bytes when the sender domain
//! is onboarded, so we never construct MIME ourselves.

use wasm_bindgen::prelude::*;
use wasm_bindgen::JsCast;
use worker::*;

/// A structured outbound email ready for the EMAIL binding.
